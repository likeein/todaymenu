        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    $con = mysqli_connect("localhost","root","","todaymenu") or die ("Can't access DB");
                    $query = "select * from recommend where not user_id in (".$id_num.") order by rand() limit 0,8";
                    $result_dish = $con->query($query);
                  } else {
                    $con = mysqli_connect("localhost","root","","todaymenu") or die ("Can't access DB");
                    $query = "select * from recommend order by rand() limit 0,8";
                    $result_dish = $con->query($query);
                  }
                          ...
                          <div class="card h-80">
                              ...
                              <div class="card-body p-4">
                                  <div class="text-center">
                                      <!-- Product name-->
                                      <h5 class="fw-bolder bolder-title">인기반찬</h5>
